...
// $config['dynamic_base_url'] = (getenv('APPLICATION_ENV') === 'development')
//     ? 'http://103.184.280ooo/antrian-loket-online/'
//     : 'https://www.antrianrsudcaruban.com/';

// // In config.php
// include('custom_config.php');
// $config['base_url'] = $config['dynamic_base_url'];
...
|--------------------------------------------------------------------------
|
| Typically this will be your index.php file, sunless you've renamed it to
