...
$date_visit_en = date('d F Y', strtotime($tickets[0]->date_visit));
    ...
    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12 p-2 bg-light mx-auto">
        ...
        <div class="p-2">
            ...
            <?php if (isset($success_message)) : ?>
                <div class="toast align-items-center text-bg-success border-0 mx-auto" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
            ...
            <?php elseif (isset($exist_message)) : ?>
                <div class="toast align-items-center text-bg-warning border-0 mx-auto" role="alert" aria-live="assertive" aria-atomic="true">
                    <div class="d-flex">
                        <div class="toast-body">
                            <?= $exist_message ?><br>Untuk tanggal kunjungan: <b><?= $date_visit ?></b>
                        </div>
                        <button type="button" class="btn-close btn-close-white me-2 m-auto" data-bs-dismiss="toast" aria-label="Close"></button>
                    </div>
                </div>
        ...
        <div class="card p-2 col-12">
                    ...
                    <div class="ticket border border-2 border-dark" style="width: 280px; height: 360px;">
                        <div class="">
                            ...
                            <label style="font: bold 100px arial, sans-serif">
                                <?= $tickets[0]->no_antrian ?>
                            </label>
                            <div class="container mb-2">
                                <div class="row">
                                    <div class="col-5" align="left">Nomor RM :</div>
                                    <div class="col-7" align="right"><?= $tickets[0]->no_rm ?></div>
                                </div>
                                <div class="row">
            ...
            <div class="rounded mx-auto pt-2">
                <a href="<?= base_url() ?>" class="btn btn-secondary btn-secondary"><i class="bi bi-chevron-left pe-2"></i>Halaman Utama</a>
            </div>
            <!-- Print -->
